...
- There are several ways to run the AgenticAI-FW-Course Labs.
...
=== "🐳 Docker (Recommended)"
    ...
    docker run -it --pull=always -p 3000:3000 ghcr.io/nirgeier/agenticai-fw-course
    ```
...
=== "![](assets/images/killercoda-icon.png){:. width-24px} Killercoda"
    ...
    * Learn in your browser without any local installation
    ...
    🌐 <a href="https://killercoda.com/codewizard/scenario/AgenticAIFWCourse" target="_blank">**Launch on Killercoda**</a>
...
=== "📜 From Source"
    ...
    git clone https://github.com/nirgeier/AgenticAI-FW-Course
    # Change to the Labs directory
    cd AgenticAI-FW-Course/Labs
...
=== "![](assets/images/gcp.png){:.width-24px} Using Google Cloud Shell"
    ...
    - Click on the `Open in Google Cloud Shell` button below:
      ...
      [![Open in Cloud Shell](https://gstatic.com/cloudssh/images/open-btn.svg)](https://console.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/nirgeier/AgenticAI-FW-Course)
